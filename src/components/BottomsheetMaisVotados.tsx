...
import { Trophy, X, ShareNetwork } from "@phosphor-icons/react";
  ...
  return (
    <>
      <style>{`
        ...
        @keyframes fade-bs-in  { from { opacity:0; } to { opacity:1; } }
        @keyframes fade-bs-out { from { opacity:1; } to { opacity:0; } }
      `}</style>
      ...
      <div
        ...
        style={{
          ...
          animation: `${animOut ? "fade-bs-out" : "fade-bs-in"} 280ms ease forwards`,
        }}
      />

      {/* Centering wrapper — NOT animated, just positions the sheet at bottom center */}
      <div style={{
        ...
        <div style={{
          ...
          boxShadow: "0px 2px 8px 0px rgba(40,41,61,0.16), 0px 16px 24px 0px rgba(96,97,112,0.16)",
        }}>

          {/* Drag handle */}
          <div style={{ height: 32, display: "flex", alignItems: "center", justifyContent: "center", paddingTop: 12, paddingBottom: 16 }}>
            <div style={{ width: 40, height: 4, background: "#3a3a3a", borderRadius: 9999 }} />
          </div>

          {/* Header — logo centered, X button right */}
          <div style={{
            display: "flex", alignItems: "center", justifyContent: "space-between",
            padding: "4px 8px 16px", backdropFilter: "blur(4px)",
          }}>
            ...
            <button
              onClick={onClose}
              style={{
                width: 40, height: 40, background: "#000", border: "1px solid #424242",
          ...
          <div style={{ padding: "8px 16px 16px", display: "flex", flexDirection: "column", gap: 16, backdropFilter: "blur(4px)" }}>
            ...
            <button style={{
              ...
              borderRadius: 9999, padding: "9px 17px", cursor: "pointer",
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              {entries.map((entry) => (
                <div key={entry.rank} style={{ background: "#000", borderRadius: 14, paddingLeft: 24, paddingRight: 8, paddingTop: 8, paddingBottom: 8 }}>
                    ...
                    <div style={{ flex: 1, background: "#1b1b1b", borderRadius: 12, display: "flex", alignItems: "center", gap: 8, padding: 8, height: 52 }}>
                      <div style={{ flex: 1, display: "flex", alignItems: "center", gap: 8, overflow: "hidden" }}>
                        ...
                        <div style={{ minWidth: 0 }}>
                          <p style={{ margin: 0, fontFamily: "var(--font-display)", fontWeight: 800, fontSize: 16, lineHeight: "18px", color: "#fff", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                            {entry.apelido.toUpperCase()}
                          </p>
                          <p style={{ margin: 0, fontFamily: "var(--font-display)", fontWeight: 500, fontSize: 12, lineHeight: "14px", color: "#8d908d" }}>
                            {entry.categoria}
                          </p>
                        </div>
                      </div>
