    ...
    <div style={{ position: "fixed", inset: 0, zIndex: 200, pointerEvents: "none" }}>
      ...
      <div
        style={{
          ...
          backdropFilter: "blur(40px) saturate(190%) brightness(1.1)",
          WebkitBackdropFilter: "blur(40px) saturate(190%) brightness(1.1)",
          border: "1px solid rgba(255,255,255,0.14)",
          borderRadius: 18,
          boxShadow: "0 16px 40px rgba(0,0,0,0.55), inset 0 1.5px 0 rgba(255,255,255,0.22)",
          overflow: "hidden",
