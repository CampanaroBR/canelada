...
import { MedalMilitary, SealCheck, Lock, CheckCircle } from "@phosphor-icons/react";

// Catálogo de badges organizados por categoria
const BADGE_CATALOG = [
  {
    id: "presenca",
    title: "PRESENÇA",
...
// Mapa slug → SVG (case-exato para Vercel/Linux)
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Section header */}
        <div style={{ display: "flex", alignItems: "center", gap: 8, width: "100%", height: 42 }}>
          <div style={{
            background: "#171717",
            border: "1px solid #2e2e2e",
            borderRadius: 12,
        ...
        {/* Filter tabs */}
        <div style={{ display: "flex", gap: 8, width: "100%", height: 38, overflowX: "auto", flexShrink: 0 }}>
                    ...
                    <div key={ri} style={{ display: "flex", gap: 8 }}>
                      {row.map(badge => {
                        ...
                        return (
                          ...
                          >
                            {/* Lock / Check icon */}
                            <div style={{ position: "absolute", top: unlocked ? 3 : 4, right: unlocked ? 5 : 6 }}>
                              {unlocked
                                ? <CheckCircle size={20} color="#9fe870" weight="fill" />
                                : <Lock size={13} color="rgba(255,255,255,0.4)" weight="fill" />
                              }
                            </div>

                            {/* Badge image */}
                            <div style={{ width: 60, height: 60, position: "relative", marginBottom: -6, flexShrink: 0 }}>
                              {/* eslint-disable-next-line @next/next/no-img-element */}
                              <img
                                alt={badge.nome}
                                src={badge.svg}
