...
const TABS = [
  { key: "MVP"     as const, label: "MVP",     color: "#9fe870", medal: "🥇" },
...
function PodiumCard({
  ...
  return (
    <div style={{
      ...
      borderRadius: "var(--radius-md)",
      boxShadow: isFirst
        ? `0 0 0 1px ${color}44, inset 0 1px 0 rgba(255,255,255,0.08)`
        : "var(--shadow-border)",
      display: "flex",
  ...
  return (
    <>
      <style>{`
        ...
        .rank-tab:active { transform: scale(0.97); }
        .rank-row {
