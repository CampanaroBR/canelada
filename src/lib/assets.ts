...
export const TRAIT_SVG: Record<string, string> = {
  "racudo":        "/traits/Racudo.png",
  "matador":       "/traits/Matador.png",
  "paredao":       "/traits/Paredao.png",
  "categoria":     "/traits/Craque.png",
  "xerife":        "/traits/Xerife.png",
  "chorao":        "/traits/Chorao.png",
  "paneleiro":     "/traits/Paneleiro.png",
  "fominha":       "/traits/Fominha.png",
  "resenha-forte": "/traits/So_resenha.png",
  "bagre":         "/traits/Bagre.png",
  "cone":          "/traits/Cone.png",
  "corpo-mole":    "/traits/Corpo_mole.png",
  "firuleiro":     "/traits/Firuleiro.png",
  "reclamao":      "/traits/Reclamao.png",
  "garcom":        "/traits/Garcom.png",
};
