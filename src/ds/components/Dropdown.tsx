...
export function Dropdown({ label, required, options, value, onChange, placeholder = "Selecione", leftIcon, disabled, error }: DropdownProps) {
  ...
  const borderColor = error ? colors.semantic.danger : open ? colors.accent.default : colors.bg.border;
    ...
    <div style={{ width: "100%" }}>
      ...
      <div ref={ref} style={{ position: "relative", width: "100%" }}>
        ...
        >
          ...
          <span style={{ flex: 1, minWidth: 0, textAlign: "left", fontFamily: font.body, fontWeight: 600, fontSize: 14, color: selected ? colors.text.primary : colors.text.muted, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
        ...
        {open && (
          <div
            ...
            style={{
              ...
              background: colors.bg.elevated, border: `1px solid ${colors.bg.border}`, borderRadius: radius.md,
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    background: active ? colors.bg.surface : "none", border: "none", borderRadius: radius.sm,
                    padding: "10px 10px", cursor: "pointer", textAlign: "left",
                    fontFamily: font.body, fontWeight: 600, fontSize: 14, color: colors.text.primary,
                    WebkitTapHighlightColor: "transparent",
                  }}
                  onMouseEnter={(e) => { if (!active) e.currentTarget.style.background = colors.bg.surface; }}
