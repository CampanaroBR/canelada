...
export const Simples: Story = {
  args: { icon: <ChartBar size={24} color="#9fe870" weight="fill" />, title: "PERSONAGEM DA SEMANA" },
};

export const ComSubtitulo: Story = {
  args: { icon: <ChartBar size={24} color="#9fe870" weight="fill" />, title: "CLASSIFICAÇÃO", subtitle: "Pontuação da galera" },
};
